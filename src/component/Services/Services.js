      ...
      <section className="services section" id="services">
        ...
        <div className="services__container container grid">
            ...
            >
              <div className="services__modal-content">
                ...
                <p className="services__modal-description">
                  Over 3 years of experience in web development providing
                  quality work.
                </p>
          ...
          <div className="services__content">
            ...
            <span className="services__button" onClick={() => this.toggleTab(2)}>
              View More
              <HiOutlineArrowSmRight className="services__button-icon" />
            </span>
            <div
          ...
          <div className="services__content">
                ...
                <span className="services__button" onClick={() => this.toggleTab(3)}>
                    View More
                    <HiOutlineArrowSmRight className="services__button-icon" />
                </span>
                <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"}>
                    <div className="services__modal-content">
                        <HiX onClick={() => this.toggleTab(0)} className="services__modal-close" />
