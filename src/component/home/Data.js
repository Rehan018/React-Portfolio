    ...
    return (
      <div className="home__data">
        ...
        <h3 className="home__subtitle">
          Backend Developer Along With Frontend Developer
        </h3>
        <p className="home__description">
        Experienced Full Stack MERN Stack Developer with a passion for crafting robust and scalable web applications. Proficient in utilizing technologies like Node.js, Express.js, MongoDB, and React.js to build dynamic and responsive solutions. Skilled in backend development, frontend design, and database management. Dedicated to delivering high-quality code and enhancing user experiences.
        </p>
